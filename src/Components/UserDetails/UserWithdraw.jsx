...
const UserWithdraw = () => {
  ...
  const filteredData = WithdrawData.filter((row) => {
  ...
  const changeStatus = async (userId, status, amount, phone) => {
    try {
      ...
      if (res.status) {
        ...
        mutate(`/admin/getnormalWithdrawdetails?page=${currentPage}&limit=10`);
      }
    } catch (error) {
  ...
  // const [normalWithdrawData, setNormalWithdrawData] = useState([]);
  // const { data: normalData } = useSWR(
  //   `/admin/getnormalWithdrawdetails?page=${currentPage}&limit=10`,
  //   fetchData // Use your custom fetcher function here
  // );

  // useEffect(() => {
  //   if (normalData && normalData.data && normalData.length) {
  //     setNormalWithdrawData(normalData.data);
                ...
                <div className="page-content">
                  ...
                  <div className="card">
                    <div className="cards-body">
                      ...
                      >
                        <h4 className="mb-0">All Withdraw</h4>
                      </div>
                      <div
                          ...
                          <div className="cards-body">
                            <div className="withdraw-status">
                              <div className="card-title">
                                <h4 className="mb-0">Withdraw History</h4>
                              </div>
                              {/* <select
